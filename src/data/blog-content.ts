...
export const blogArticles: BlogArticle[] = [
  {
    ...
    excerpt: "Panorama Tatr, poranna cisza i wygodna baza pod Gubałówką. Ten tekst pokazuje, dlaczego Ząb działa dziś lepiej niż ścisłe centrum Zakopanego.",
  ...
  },
  {
    ...
    excerpt: "Trasy bez tłumu, poranne światło i realne czasy przejścia. Ten przewodnik pokazuje spokojniejszą stronę Gubałówki.",
  ...
  },
  {
    ...
    excerpt: "Widok, cisza, dobrze zaprojektowane wnętrza i kolacja bez pośpiechu. Ten tekst układa spokojny scenariusz weekendu we dwoje.",
